...
use crate::types::{
    ColumnDef, Fix, FixReport, ParsedDoogat, TableSchema, TitleSource, DoogatFix, Zone,
};
use regex::Regex;
...
fn interpolate_title_template(template: &str, parsed: &ParsedDoogat, schema: &TableSchema) -> Option<String> {
...
mod tests {
    use super::*;
    use crate::types::{InlineField, Section, Severity, TitleSource, DoogatMeta, Zone};
    ...
    fn title_from_path_underscore_slug() {
        assert_eq!(
            title_from_path("ddb/20260315120000_my_note.md"),
            "My note"
        );
    }
