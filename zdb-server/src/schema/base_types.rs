...
pub(crate) fn zettel_to_value(z: &ParsedZettel) -> GqlValue {
...
pub(crate) fn typed_zettel_to_value(z: &ParsedZettel, schema: &TableSchema) -> GqlValue {
...
pub(crate) fn extract_typed_field(z: &ParsedZettel, col: &ColumnDef) -> GqlValue {
...
pub(crate) fn zettel_object(name: &str) -> Object {
    Object::new(name)
...
pub(crate) fn event_stream(
    rx: broadcast::Receiver<events::ZettelEvent>,
) -> impl futures_util::Stream<Item = async_graphql::Result<events::ZettelEvent>> {
