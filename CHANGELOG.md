...
- **indexer**: a single unreadable or malformed file in an incremental reindex no longer aborts the whole change-set - the bad file is skipped with a structured warning and the remaining files still index.
